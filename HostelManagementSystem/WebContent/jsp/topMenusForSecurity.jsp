	...
	<table width="100%" border="0" align="center" bgcolor="#085753" cellspacing="0" cellpadding="5">
		<tr>
			...
			<td align="left" width="5%">
				<div class="nav">
					<ul id="drop-nav">
						<li><a href="#" style=" color:#ffffff;">Vehicle</a>
							<ul>
								<li><a href="vehicleEntry.jsp" style=" color:#ffffff;">Add Vehicle Entry</a></li>
								<li><a href="unleavedVehicleDetails.jsp" style=" color:#ffffff;">Unleaved Vehicles</a></li>
						  		<li><a href="vehicleReport.jsp" style=" color:#ffffff;">Vehicle Report</a></li>
