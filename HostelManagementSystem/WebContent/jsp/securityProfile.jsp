...
<head>
	...
	<%
		User user=(User)session.getAttribute("user");
	     ...
	     security=SecurityDAO.getSecurityDetails(user.getUserId());
						...
						<td align="right" width="70%">
							<table width="100%" align="center">
							   <tr>
								...
								<tr>
									<td align="center" ><input style="background-color: silver;" type="text" bgcolor= "silver" value=<%=security.getFirstName() %> readonly></td>
									<td align="center"><input  style="background-color: silver;" type="text" bgcolor="silver" value=<%=security.getMiddleName() %> readonly></td>
									<td align="center"><input  style="background-color: silver;" type="text" bgcolor="silver" value=<%=security.getLastName() %> readonly></td>	
								</tr>
								<tr>
							   ...
							   <tr>
							   	<td align="center" ><input style="background-color: silver;" type="text" bgcolor= "silver" value=<%=security.getDob() %> readonly></td>
							   	<td align="center" ><input style="background-color: silver;" type="text" bgcolor= "silver" value=<%=security.getGender() %> readonly></td>
							   	<td align="center" ><input style="background-color: silver;" type="text" bgcolor= "silver" value=<%=security.getUid() %> readonly></td>
							   </tr>
								<tr>
								...
								<tr>
									<td align="center"><input style="background-color: silver;" type="text" bgcolor= "silver" value=<%=security.getEmail() %> readonly></td>
									<td align="center"><input style="background-color: silver;" type="text" bgcolor= "silver" value=<%=security.getContact() %> readonly></td>
									<td align="center"><input style="background-color: silver;" type="text" bgcolor= "silver" value=<%=security.getAlternateContact() %> readonly></td>
								</tr>
							</table>
						</td>
						...
						<tr>
							<td>
								<table align="center">
									...
									<tr>
										<td align="center"><input name="currentAddress"  style="background-color: silver;" value=<%=security.getCurrentAddress() %> rows="4" cols="30" readonly></td>
										<td>&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
										<td align="center"><input name="currentAddress"  style="background-color: silver;" value=<%=security.getPermanentAddress() %> rows="4" cols="30" readonly></td>
									</tr>
							</table>
						</td>
					</tr>
				...
				<tr>
						...
						<hr>
							<table width="60%">
								...
								<tr>
									<td align="center"><input style="background-color: silver;" type="text" bgcolor= "silver" value=<%=security.getEmployeeId() %> readonly></td>
									<td align="center"><input style="background-color: silver;" type="text" bgcolor= "silver" value=<%=security.getQualification() %> readonly></td>
									<td align="center"><input name="guardianAddress"  style="background-color: silver;" value=<%=security.getDesignation() %> readonly></td>	 
								</tr>
								<tr>
									<td align="center" style="font-size:15;"><font color="blue">Experience</font></td>
								</tr>
								<tr>
									<td align="center"><input style="background-color: silver;" type="text" bgcolor= "silver" value=<%=security.getExperience() %> readonly></td>
								</tr>
							</table>
							<hr>
						</td>
