	...
	<table width="100%" border="0" align="center" bgcolor="#085753" cellspacing="0" cellpadding="5">
		<tr>
			...
			<td align="left" width="5%">
				<div class="nav">
					<ul id="drop-nav">
						<li><a href="#" style=" color:#ffffff;">People</a>
							<ul>
						  		<li><a href="rectors.jsp" style=" color:#ffffff;">Rectors</a></li>
						  		<li><a href="gateGuards.jsp" style=" color:#ffffff;">Gate Guards</a></li>
						  		<li><a href="administrativeStaff.jsp" style=" color:#ffffff;">Administrative Staff</a></li>
						  	</ul>
					  	</li>
					</ul>
				</div>
