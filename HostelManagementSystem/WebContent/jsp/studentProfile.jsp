					...
					<table align="right" width="80%">
						...
						<td align="right" width="70%">
							<table width="100%" align="left">
								...
								<tr>
									<td align="center" ><input style="background-color: silver;" type="text" bgcolor= "silver" value=<%=student.getFirstName() %> readonly></td>
									<td align="center"><input  style="background-color: silver;" type="text" bgcolor="silver" value=<%=student.getMiddleName() %> readonly></td>
									<td align="center"><input  style="background-color: silver;" type="text" bgcolor="silver" value=<%=student.getLastName() %> readonly></td>	
								</tr>
								<tr>
							   ...
							   <tr>
							   	<td align="center" ><input style="background-color: silver;" type="text" bgcolor= "silver" value=<%=student.getDob() %> readonly></td>
							   	<td align="center" ><input style="background-color: silver;" type="text" bgcolor= "silver" value=<%=student.getGender() %> readonly></td>
							   	<td align="center" ><input style="background-color: silver;" type="text" bgcolor= "silver" value=<%=student.getUid() %> readonly></td>
							   </tr>
								<tr>
								...
								<tr>
									<td align="center"><input style="background-color: silver;" type="text" bgcolor= "silver" value=<%=student.getEmail() %> readonly></td>
									<td align="center"><input style="background-color: silver;" type="text" bgcolor= "silver" value=<%=student.getContact() %> readonly></td>
									<td align="center"><input style="background-color: silver;" type="text" bgcolor= "silver" value=<%=student.getParentContact() %> readonly></td>
								</tr>
							</table>
						</td>
						<td align="left" width="30%">
							<table align="center" width="100%">
								<tr>
									<td align="center">
										<img src="./students/photo/<%=student.getPhoto() %>" width="50%" height="80">
									</td>
								</tr>
								<tr>
									<td align="center">
										<img src="./students/sign/<%=student.getPhoto() %>" width="50%" height="30"/>		
									</td>
								</tr>
							</table>
						</td>
						...
						<tr>
							<td>
								<table align="center">
									...
									<tr>
										<td align="center"><input name="currentAddress"  style="background-color: silver;" value=<%=student.getCurrentAddress() %> rows="4" cols="30" readonly></td>
										<td>&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
										<td align="center"><input name="currentAddress"  style="background-color: silver;" value=<%=student.getPermanentAddress() %> rows="4" cols="30" readonly></td>
									</tr>
							</table>
						</td>
					</tr>
						...
						<td align="center">
						   ...
						   <hr>
							<table width="60%">
								...
								<tr>
									<td align="center"><input style="background-color: silver;" type="text" bgcolor= "silver" value=<%=student.getGuardianName() %> readonly></td>
									<td align="center"><input style="background-color: silver;" type="text" bgcolor= "silver" value=<%=student.getGuardianOccupation() %> readonly></td>
									<td rowspan="2">
									    &nbsp;&nbsp;&nbsp;&nbsp;
										<input name="guardianAddress"  style="background-color: silver;" value=<%=student.getGuardianAddress() %> rows="4" cols="30" readonly>
									</td>	 
								</tr>
								<tr>
								...
								<tr>
									<td align="center"><input style="background-color: silver;" type="text" bgcolor= "silver" value=<%=student.getGuardianEmail() %> readonly></td>
									<td align="center"><input style="background-color: silver;" type="text" bgcolor= "silver" value=<%=student.getGuardianContact() %> readonly></td>
								</tr>
							</table>
							<hr>
						</td>
					...
					<tr>
						<td align="center">
							<table lign="center" width="60%">
								...
								<tr>
									<td align="center"><input style="background-color: silver;" type="text"  value=<%=student.getDeptName() %> readonly></td>
									<td align="center"><input style="background-color: silver;" type="text"  value=<%=student.getQualification() %> readonly></td>
									<td align="center"><input style="background-color: silver;" type="text"  value=<%=student.getCourseName() %> readonly></td>
								</tr>
								<tr>
								...
								<tr>
									<td align="center"><input style="background-color: silver;" type="text"  value=<%=student.getCourseDuration() %> readonly></td>
									<td align="center"><input style="background-color: silver;" type="text" value=<%=student.getCourseYear() %> readonly></td>
									<td align="center"><input style="background-color: silver;" type="text" value=<%=student.getEligibilityNo() %> readonly></td>
								</tr>
								<tr>
									<td align="center" style="font-size:15;"><font color="blue">Admission Date</font></td>
								</tr>
								<tr>
									<td align="center"><input style="background-color: silver;" type="text"  value=<%=student.getAdmissionDate() %> readonly></td>
								</tr>
							</table>
							<hr>
						</td>
					...
					<tr>
						<td align="center">
							<table>
								...
								<tr>
									<td align="center"><input style="background-color: silver;" type="text"  value=<%=student.getHostelNo() %> readonly></td>
								    <td align="center"><input style="background-color: silver;" type="text"  value=<%=student.getRoomNo() %> readonly></td>
								</tr>
							</table>
							<hr>
						</td>
